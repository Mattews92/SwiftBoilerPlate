...
class HSBColorPicker : UIView {
    ...
    weak internal var hsbDelegate: HSBColorPickerDelegate?
    ...
    @objc func touchedColor(gestureRecognizer: UILongPressGestureRecognizer){
        ...
        self.hsbDelegate?.HSBColorColorPickerTouched(sender: self, color: color, point: point, state:gestureRecognizer.state)
    }
}
